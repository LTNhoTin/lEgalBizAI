...
GEMINI_API_KEY = "AIzaSyC8GTtZzzkm7f-fVkO71xnbKUs7dUHW_3E"  # Thay API key 
...
async def stream_get_answer(model, prompt):
    ...
    async with httpx.AsyncClient(timeout=None) as client:
        ...
        if model == "LegalBizAI_pro":
            ...
            return res_json.get("response", "Không có phản hồi từ model GPT-OSS-20B")
