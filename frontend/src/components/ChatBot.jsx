...
function ChatBot(props) {
    ...
    return (
        <div
            className="bg-gradient-to-r from-orange-100 to-[#e5bc8b] flex flex-col w-full flex-grow"
        ...
        >
            ...
            <div className="lg:hidden p-2 flex justify-center bg-gradient-to-r from-orange-100 to-[#e5bc8b]">
                <select
                    value={model}
          ...
          rounded-3xl border-2 md:w-[50%] md:p-3 p-1 w-full overflow-auto scroll-y-auto flex-grow"
                ...
                <div
                    className="grid md:w-[50%] p-1 rounded-t-lg hide-on-small-screen"
                    style={{ zIndex: 10 }}
                >
                    <textarea
