...
function HomePage() {
  return (
    <div className="flex flex-col items-center justify-center w-full flex-grow bg-gradient-to-r from-orange-100 to-[#e5bc8b]" style={{ minHeight: 'calc(100vh - 4rem - 3rem)' }}>
      <div className="text-center p-4 flex flex-col items-center justify-center w-full">
